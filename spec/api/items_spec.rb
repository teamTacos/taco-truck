...
describe 'Items API' do
  ...
  it "sends an item by id" do
    ...
    get "/api/locations/#{location.id}/items/#{item.id}"
  ...
  it "creates an item" do
    ...
    post "/api/locations/#{location.id}/items", body: item
  ...
  it "updates an item" do
    ...
    put "/api/locations/#{location.id}/items/#{item.id}", body: location
  ...
  it "deletes an item" do
    ...
    delete "/api/locations/#{location.id}/items/#{item.id}"
